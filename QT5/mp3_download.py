from PyQt5.QtWidgets import (QWidget, QLineEdit, QPushButton, QSystemTrayIcon, QFileDialog, QFormLayout, QApplication)
...
class Main(QWidget):
    ...
    def select_path(self):
        ...
        print('path selecionado : ', self.path)
